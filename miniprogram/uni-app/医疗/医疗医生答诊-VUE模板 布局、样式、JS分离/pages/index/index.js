...
import app from "../../App.vue"
	...
	export default {
		...
		methods: {
			...
			*/
			me_3_click:function(event){
			
			   uni.navigateTo({
			   url:'/pages/member/my/my'
			  })
			},
			...
			* 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
			*/
			index_5_5_click:function(event){
			...
			* 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
			*/
			index_8_8_click:function(event){
			...
			* input处理函数
			*/
			index_9_input:function(event){
			    this.index_9=event.target.value;
			...
			* 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
			*/
			index_12_12_click:function(event){
			...
			* 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
			*/
			btAnswer_18_click:function(event){
