...
const routes: Route[] = [
  {
    ...
    children: [
      ...
      },
      {
        path: "memoCom",
        name: "memoCom",
        component: pages.react.MemoCom,
      },
      {
        path: "classTest",
        name: "classTest",
        component: pages.react.ClassTest,
      },
      {
        path: "listenRef",
        name: "listenRef",
        component: pages.react.ListenRef,
      },
    ],
  },
  // {
  ...
  // },
  {
    ...
    children: [
      ...
      },
      {
        path: "react-image",
        name: "ReactImage",
        component: pages.lib.ReactImage,
      },
      {
        path: "r-components",
        name: "RComponents",
        component: pages.lib.RComponents,
      },
      {
        path: "heatmap",
        name: "Heatmap",
        component: pages.lib.Heatmap,
      },
    ],
  },
  {
    ...
    children: [
      {
        path: "useCreation",
        name: "useCreation",
        component: pages.ahooks.UseCreation,
      },
    ],
  },
]
